export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wxb4d9c69116d0d0c1",
  APP_SECRET: "000d927f565fdf410cc2aa052b87c1ce",
  ...
  USERS: [
    {
      ...
      id: "oB49U6KK5A4b9bhKRop3KIZLaN6o",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "ylM-bZnkMvc1ciuGSDpQ2lx9GO3k_tWi4yvPaxeR8a4",
      // 所在省份
      province: "陕西",
      // 所在城市
      city: "咸阳",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1994", "date": "12-17"},
      ...
      customizedDateList: [
        ...
        // 距离你的生日
        {"keyword": "marry_day", date: "2022-12-17"},
        // 距离我的生日
